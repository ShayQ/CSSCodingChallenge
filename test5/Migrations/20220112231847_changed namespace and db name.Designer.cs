...
namespace WebAPI.Migrations
{
    ...
    [Migration("20220112231847_changed namespace and db name")]
    partial class changednamespaceanddbname
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebAPI.Model.Fund", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebAPI.Model.FundValues", b =>
                {
            ...
            modelBuilder.Entity("WebAPI.Model.FundValues", b =>
                {
                    b.HasOne("WebAPI.Model.Fund", "Fund")
                        .WithMany("FundValues")
